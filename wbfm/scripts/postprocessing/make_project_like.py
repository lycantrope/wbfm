...
ex.add_config(project_path=None, target_directory=None, target_suffix=None, steps_to_keep=None, DEBUG=False)
...
def main(_config, _run):
    ...
    make_project_like(project_path, target_directory=target_directory,
                      target_suffix=target_suffix, steps_to_keep=steps_to_keep, verbose=1)
